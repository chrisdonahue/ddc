...
class SymNet:
    def __init__(self,
        ...
        if do_rnn:
            ...
            feats_nosym = tf.concat([feats_conv, feats_other],1)
            ...
            rnn_inputs = tf.split(rnn_inputs, nunroll, 1)
            ...
            rnn_output_inspect = tf.concat(outputs,1)
            ...
            feats_all = tf.concat([feats_sym, feats_conv, feats_other],1)
